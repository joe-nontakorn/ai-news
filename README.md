...
|-----------|--------------|
| 8:00 AM & 1:00 PM | `0 8,13 * * *` |
| 7:00 AM   | `0 7 * * *`   |
| 8:00 AM   | `0 8 * * *`   |
| 1:00 PM (13:00) | `0 13 * * *` |

> **หมายเหตุ**: บอทได้รับการตั้งค่าให้รันบน Timezone `Asia/Bangkok` (เวลาไทย) เป็นค่าเริ่มต้นแล้ว ดังนั้นคุณสามารถใส่เวลาของประเทศไทยลงใน `CRON_SCHEDULE` ได้โดยตรง!
